...
json_data = {
    ...
    'playbackContext': {
        'contentPlaybackContext': {
            'currentUrl': '/watch?v=0iTTEpdjWy0',
            'vis': 0,
            'splay': False,
